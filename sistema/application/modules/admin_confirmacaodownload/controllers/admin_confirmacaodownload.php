...
class Admin_confirmacaodownload extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->breadcrumbs[] = array('link' => 'javascript:void(0);', 'title' => 'Confirma&ccedil;&atilde;o');
        $this->breadcrumbs[] = array('link' => 'javascript:void(0);', 'title' => 'Download');

        /* info dislay */
        $this->data['info'] = array(
            'title' => 'Confirma&ccedil;&atilde;o',
            'description' => 'Gerenciador de Confirma&ccedil;&atilde;o de download',
            'menu_active' => 'servicos',
            'submenu_active' => 'confirmacao'
        );
