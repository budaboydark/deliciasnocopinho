<?php
	...
	if($codigoboleto) 
	{
		...
		switch ($tipoguia){	
			case 'des':	
				...
				$Atividades="Presta&ccedil;&atilde;o de servi&ccedil;o(s)";
			...
			case 'des_issretido':	
				...
				list($Receita)=mysql_fetch_array($sql_receita);
				$Atividades="Servi&ccedil;o Tomado";
			...
			case 'dif_des':	
				...
				$Atividades="Institui&ccedil;&atilde;o financeira";								
				list($Cnpj,$RazaoSocial,$EndSacado,$Competencia)=mysql_fetch_array($sql_des);
			...
			case 'doc_des':
				...
				");		
				$Atividades="Opera&ccedil;&atilde;o de cart&oacute;rio";	
				list($Cnpj,$RazaoSocial,$EndSacado,$Competencia)=mysql_fetch_array($sql_des);	
	...
	$tipoProduto="8"; // para definir como arrecada&ccedil;&atilde;o
	$tipoSegmento="1"; //para definir como prefeitura
	$tipoValor="9"; // Define o modulo de gera&ccedil;&atilde;o do digito verificador
