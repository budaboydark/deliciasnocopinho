...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="5">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td style="border:#000000 solid 2px;">CNPJ/Inscr. Municipal/CPF:<br><?php if($Cnpj!=""||$cpf!=""){echo $Cnpj.$cpf;}else{echo "N&atilde;o Informado";} ?></td>
        <td></td>
        <td style="border:#000000 solid 2px;">C&oacute;digo da Arrecada&ccedil;&atilde;o<br><?php echo $codigoboleto; ?></td>
      </tr>
    </table>    
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td style="border:#000000 solid 2px;"><?php if($tipocodigo==" codtomador "){echo "RESPONS&Aacute;VEL TRIBUT&Aacute;RIO: <br />";}else{echo "NOME: <br />";} if($RazaoSocial!=""){echo strtoupper($RazaoSocial);}else{echo "N&atilde;o Informado";} ?></td>
      </tr>
    </table>   
    </td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td style="border:#000000 solid 2px;">ENDERE&ccedil;O:<br><?php if($EndSacado!=""){echo strtoupper($EndSacado.", ".$Numero);}else{ echo "N&atilde;o Informado";} ?></td>
      </tr>
    </table>       
    </td>
  </tr>
      ...
      <tr>
		...
		while(list($Atividades)=mysql_fetch_array($queryatividades)){
			...
			if(strlen($Atividades)>45) { 
				  ...
				  echo $contservicos." - ".strtoupper($Atividades)."<br />";
			}
		$contservicos++;
		} ?></td>
      </tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
		...
		<br><br>
        VALOR V&aacute;LIDO PARA PAGAMENTO ATÉ <?php echo $vencimento;?>.<br>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
		...
		if($guiaPaga == "S"){
		?>
        <font color="#FF0000" size="+1">GUIA PAGA</font><br />
        <?php
		}
		?>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="0">
          ...
          <tr>
            ...
            <td align="center">R$ <?php echo DecToMoeda($valorbl-$valormulta);?></td>
          </tr>
        </table>        
        </td>
      </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td style="border:#000000 solid 2px;">CNPJ/Inscr. Municipal/CPF:<br>
            <?php if($Cnpj!=""||$cpf!=""){echo $Cnpj.$cpf;}else{echo "N&atilde;o Informado";} ?></td>
        <td></td>
