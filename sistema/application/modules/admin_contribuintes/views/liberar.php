<div id="list" class="subcontent">
    <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable1" data-source="admin/<?php echo $this->uri->segment(2); ?>/index/list">
        ...
        <thead>
            <tr>
                <th class="head1 nosort"><a class="btn btn_print" id="liberar" href="javascript:void(0);"><span>Imprimir</span></a></th>
        ...
        <tbody data-rel="<?php echo site_url('admin/' . $this->uri->segment(2) . '/editar/'); ?>">
            ...
            foreach ($data as $_data):
                ...
                <tr class="gradeX con<?php echo ($i % 2 == 0 ? '0' : '1'); ?>" data-rel="<?php echo site_url('admin/' . $this->uri->segment(2) . '/editar/' . $_data['id']); ?>">
                    ...
                    <td class="noclick"><?php echo $_data['inscr_municipal']; ?></td>
                    <td class="noclick"><?php echo $_data['razao_social']; ?></td>
                    <td class="noclick"><?php echo $_data['cnpj']; ?></td>
                    <td class="noclick"><?php echo $_data['logradouro']; ?></td>
                    <td class="noclick"><?php echo $_data['estado'] == 'A' ? 'Ativo' : 'Inativo'; ?></td>
                </tr>
    <?php $i++;
endforeach; ?>
        </tbody>
    ...
    <form  id="form_liberar" target="_blank" method="post" action="<?php echo site_url('admin/imprimir/liberacao'); ?>"></form>
</div>