<div class="centercontent tables">
    ...
    <div class="pageheader">
        ...
        <ul class="hornav">
            ...
            <li class="<?php if($this->uri->segments[3] == 'edit' && $this->uri->segments[4] != '') echo 'current'; ?>"><a href="javascript:void(0);">Editar</a></li>
            <!-- <li class="<?php if($this->uri->segments[3] == 'edit' && $this->uri->segments[4] == '') echo 'current'; ?>"><a href="<?php echo site_url('admin/'.$this->uri->segment(2).'/edit'); ?>">Adicionar</a></li> -->
        </ul>
    </div><!--pageheader-->
