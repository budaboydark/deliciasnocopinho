<a href="<?php echo site_url('admin/'.$this->uri->segment(2).'/refact'); ?>" class="btn btn_bulb"><span>Recarregar</span></a><br /><br />    	
<form  method="post" action="<?php echo site_url('admin/'.$this->uri->segment(2).'/save'); ?>" >
