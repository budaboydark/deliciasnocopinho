...
if ($_POST) {
    ...
    $CODIGO = $id;
    $this->db->select('pg.nosso_numero,pg.valor_total,pc.cnpj,pc.razao_social,pc.logradouro,pd.competencia,pg.data_vencimento,pd.valor_multa,pd.valor_juros,pd.base_calculo');
    ...
    $valorbl = $valorbl + $valormulta + $juros;
