            ...
            <tr>
                <td align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr>
                            <td style="border:#000000 solid 2px;">CNPJ/Inscr. Municipal/CPF:<br><?php if ($Cnpj != "" || $cpf != "") {
    echo $Cnpj . $cpf;
} else {
    echo "N&atilde;o Informado";
            ...
            <tr>
                <td align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr>
                            <td style="border:#000000 solid 2px;"><?php if ($tipocodigo == " codtomador ") {
    echo "RESPONS&Aacute;VEL TRIBUT&Aacute;RIO: <br />";
} else {
    echo "NOME: <br />";
} if ($RazaoSocial != "") {
    echo strtoupper($RazaoSocial);
} else {
    echo "N&atilde;o Informado";
} ?></td>
                        </tr>
            ...
            <tr>
                <td align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr>
                            <td style="border:#000000 solid 2px;">ENDERE&ccedil;O:<br><?php if ($EndSacado != "") {
    echo strtoupper($EndSacado . ", " . $Numero);
} else {
    echo "N&atilde;o Informado";
} ?></td>
                        </tr>
