                	...
                	<?php
                		switch($data['input_type']){
	                		...
	                		case 'image':
	                			...
	                			echo '<br />';
	                			if(read_file($this->contribuinte_model->config_directory.$data['value']))
	                				echo img(array('src'=>image("media/".$this->contribuinte_model->config_directory.$data['value'], "100x0")  ,'class'=>'thumb_image'));
	                		break;
                		}                	
                	?>
                </span>
