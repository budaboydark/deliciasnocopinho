<div id="list" class="subcontent">
    <table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable3" data-source="admin/<?php echo $this->uri->segment(2); ?>/index/list">
        ...
        <tbody data-rel="<?php echo site_url('admin/' . $this->uri->segment(2) . '/adicionar/'); ?>">
            <?php $i = 0;
            foreach ($data as $_data): ?>
                <tr class="gradeX con<?php echo ($i % 2 == 0 ? '0' : '1'); ?>" data-rel="<?php echo site_url('admin/' . $this->uri->segment(2) . '/adicionar/' . $_data['id']); ?>">
                    <td align="center">
                        <span class="center"><input type="hidden" name="id" value="<?php echo $_data['id']; ?>" /></span>
                    </td>
