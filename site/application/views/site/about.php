<div class="section primary-section" id="about">
            ...
            <div class="container">
                <div class="title">
                    <h1>Sobre nós</h1>
                    <p>Delicias no copinho.</p>
                </div>
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            <img src="<?php echo base_url(); ?>template/pluton/images/sobre/01.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                    ...
                    <div class="span4" id="second-person">
                        <div class="thumbnail">
                            <img src="<?php echo base_url(); ?>template/pluton/images/sobre/02.png" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="<?php echo base_url(); ?>">
                    ...
                    <div class="span4" id="third-person">
                        <div class="thumbnail">
                            <img src="<?php echo base_url(); ?>template/pluton/images/sobre/03.png" alt="team 1">
                            <h3>Sr. & Sra. Copinho</h3>
                            <ul class="social">
                                <li>
                                    <a href="<?php echo base_url(); ?>">
                                        <span class="icon-facebook-circled"></span>
